...
import MasterDataRoleDetailComponent from '@/components/MasterData/Role/MasterDataRoleDetailComponent'
...
export default connect(
  ...
  class MasterDataRoleDetailContainer extends Component {
    static propTypes = {
