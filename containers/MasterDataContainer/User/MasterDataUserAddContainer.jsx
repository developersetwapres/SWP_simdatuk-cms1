...
import MasterDataUserAddComponent from '@/components/MasterData/User/MasterDataUserAddComponent'

export default connect(
  mapStateToProps('role', 'employee', 'user'),
  mapActions('getRoles', 'getEmployees', 'postUser')
)(
  class MasterDataUserAddContainer extends Component {
    static propTypes = {
