...
const initialState = {
  ...
  error: null,
  employees: [],
  employeesDetailCompare: [],
  employeesDetailPromotion: [],
  employeesPagination: {},
  unoccupiedPositions: [],
...
export const promotions = (state = initialState, actions) => {
  ...
  switch (actions.type) {
    ...
    case GET_PROMOTION_USERS_REQUESTED:
      return {
        ...state,
        loading: true
      }
    ...
    case GET_COMPARE_USERS_SUCCESS:
      return {
        ...state,
        loading: false,
        employeesDetailCompare: payload?.data
      }
    case GET_PROMOTION_USERS_SUCCESS:
      return {
        ...state,
        loading: false,
        employeesDetailPromotion: payload?.data
      }
    // FAILED
    ...
    case GET_PROMOTION_USERS_FAILED:
      return {
        ...state,
        loading: false,
        error: payload?.error
