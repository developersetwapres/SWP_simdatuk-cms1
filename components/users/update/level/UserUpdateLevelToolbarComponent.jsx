...
import { primaryButtonStyle, successButtonStyle } from '@/utils/theme'
import { blackButtonStyle, dangerButtonStyle } from '@/utils/theme'
import PropTypes from 'prop-types'
import { useRouter } from 'next/router'

function UserUpdateLevelToolbarComponent({
  values,
  errors,
  importExcel,
  exportExcel,
  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <Button
              ...
              onClick={exportExcelUserLevel}
              isBusy={exportExcel.downloadTemplate.userLevel}
          ...
          >
            <div style={{
              ...
              <p style={{
                ...
                fontWeight: '400',
                fontSize: '14px'
              }}>{values.level.name || 'No File Choosen'}</p>
            </div>
          </Grid>
        </Grid>
      </Grid>
      ...
      >
        ...
        >
          <p>Cara mengupdate Level Pengguna</p>
          <ul>
      ...
      >
        ...
        <p style={{
          ...
          fontSize: '22px',
          marginTop: '30px'
        }}>Apakah anda yakin akan Update Level Pengguna</p>
        <Box
          component='div'
          sx={{
            display: 'flex',
        ...
        <div style={{
          ...
          <div>
            ...
            <div style={{
              ...
              <h2>Update Level sedang diproses</h2>
