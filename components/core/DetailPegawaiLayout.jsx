...
const DetailPegawaiLayout = ({ children }) => {
  const dataPegawai = [
    'Data Pegawai',
    'Riwayat Pendidikan',
    'Riwayat Golongan',
    ...
    <Container width='lg'>
      <Grid container justifyContent='space-between'>
        <Grid container item justifyContent='space-between'>
          <Box>
            <Typography fontWeight='bold'>Detail Profile</Typography>
          </Box>
        ...
        >
          ...
          <Box component='div'>
            ...
            >
              <Box>
                <Typography component='h5'>Eselon</Typography>
                <Typography fontSize={14} fontWeight='500'>
                  Abc
                </Typography>
              </Box>
              <Box>
                <Typography component='h5'>Golongan</Typography>
                <Typography fontSize={14} fontWeight='500'></Typography>
              </Box>
              <Box>
                <Typography component='h5'>NIP/NRP</Typography>
                <Typography fontSize={14} fontWeight='500'></Typography>
              </Box>
            </Box>
          </Box>
