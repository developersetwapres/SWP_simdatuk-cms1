...
const RiwayatPelatihanTeknisEditComponent = ({
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      formData.append('group_id', handleGetValueID(values?.rumpun, 'groups'))
  ...
  return (
    ...
    >
      {(formikProps) => (
        <LayoutPages
          summary={'Edit Riwayat Pelatihan Teknis'}
...
RiwayatPelatihanTeknisEditComponent.propTypes = {
...
export default RiwayatPelatihanTeknisEditComponent
