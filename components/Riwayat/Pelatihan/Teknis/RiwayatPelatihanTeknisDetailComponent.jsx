  ...
  return (
    <>
      <LayoutPages
        ...
        summary='Detail Riwayat Pelatihan Teknis'
        action={action}
      >
      ...
      <ModalConfirmDelete
        ...
        title='Hapus Riwayat Pelatihan Teknis'
        copytext='Apakah anda yakin akan menghapus riwayat pelatihan teknis?'
        open={modalDelete}
...
RiwayatPelatihanTeknisDetailComponent.propTypes = {
...
export default RiwayatPelatihanTeknisDetailComponent
