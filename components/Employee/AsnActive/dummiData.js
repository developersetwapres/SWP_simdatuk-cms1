...
export const pejabatFungsionalKeahlian = [
  {
    id: 1,
    path: '/komposisi-pegawai/',
...
export const pejabatFungsionalKeterampilan = [
  {
    id: 1,
    path: '/komposisi-pegawai/',
...
export const pejabatKemensetneg = [
  {
    id: 1,
    path: '/komposisi-pegawai/',
...
export const tenagaOutsourcing = [
  {
    id: 1,
    path: '/komposisi-pegawai/',
    name: 'Pengemudi',
