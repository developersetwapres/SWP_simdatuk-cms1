...
const RiwayatAssessmentSection = ({ data = [] }) => {
            ...
            <>
              {
                item?.assessment_document ?
                  <Button
                    text='Lihat File'
                    onClick={() => openInNewTab(item?.assessment_document)}
                  /> :
...
RiwayatAssessmentSection.propTypes = {
  data: PropTypes.array
}

export default RiwayatAssessmentSection
